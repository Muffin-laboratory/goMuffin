...
func InfoBot(e *handler.CommandEvent) error {
	...
	counts, err := repository.GetDatabase().Counts(e.Ctx, int64(e.User().ID))
	if err != nil {
		return err
	}
